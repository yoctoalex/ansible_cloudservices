...
options:
    ...
    action:
        description:
            ...
            - When C(absent), will remove provided IPs from the EAP application
...
class ModuleManager(object):
    ...
    def update_on_cloud(self, payload, subscription_id):
        # raise F5ModuleError(json.dumps(payload))
